...
export interface TokenRegistry {
  ...
  /**
   * The tokens as resolved CSS custom properties, every theme, for HTML that
   * loads no stylesheet (`duro mockup seed` inlines it). Same names as
   * `@duro-app/tokens/vars.css`; generated by packages/tokens.
   */
  mockupCss: string
}
